...
class GenerateHandwritingParams(BaseModel):
    ...
    embed_diagram: str = "false"
    diagram_png_base64: str = ""
    diagram_caption: str = "图示"
    use_sukoya_optimized_renderer: str = "true"
    handwriting_chaos: str = "60"
    ink_bleed_count: str = "0"
    handwriting_profile: str = "sukoya"
